...
You can read the latest release notes [here](https://docs.redhat.com/en/documentation/red_hat_trusted_profile_analyzer/2.2/html/release_notes/index).
...
You can find license information within the [LICENSE](You can find license information within the [LICENSE](https://github.com/trustification/trusted-profile-analyzer-ansible/blob/release/2.2.z/LICENSE) file.
