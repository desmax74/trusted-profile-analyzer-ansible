...
| tpa_single_node_ui_scopes |Custom OIDC scopes for UI frontend client. Read from TPA_UI_SCOPES env var. Sets UI_SCOPES environment variable in server deployment. | str |  |
